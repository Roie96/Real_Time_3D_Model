...
def two_cameras():
	...
	print("Left_Stereo_Map_x:", Left_Stereo_Map_x)
	print("Left_Stereo_Map_y:", Left_Stereo_Map_y)
	print("Right_Stereo_Map_x:", Right_Stereo_Map_x)
	print("Right_Stereo_Map_y:", Right_Stereo_Map_y)
