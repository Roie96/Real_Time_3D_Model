...
while True:
	...
	imgB= frames[0]
	imgT = frames[cv2.getTrackbarPos('frameDiff')]
	imgB = cv2.rotate(imgB, cv2.ROTATE_90)
	imgT = cv2.rotate(imgT, cv2.ROTATE_90)
	...
	if retL and retR:
		...
		cv2.rotate(disparity, cv2.ROTATE_90_COUNTERCLOCKWISE)
